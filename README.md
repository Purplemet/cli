...
| Platform | Type | Guide |
|----------|------|-------|
| **GitHub Actions** | Composite Action | [Documentation](https://github.com/Purplemet/cli/wiki/github-actions) |
| **GitLab CI/CD** | Include Template | [Documentation](https://github.com/Purplemet/cli/wiki/gitlab-ci) |
| **Bitbucket Pipelines** | Docker Pipe | [Documentation](https://github.com/Purplemet/cli/wiki/bitbucket-pipelines) |
| **Jenkins** | Shared Library | [Documentation](https://github.com/Purplemet/cli/wiki/jenkins) |
| **Azure DevOps** | Marketplace Extension | [Documentation](https://github.com/Purplemet/cli/wiki/azure-devops) |

> Only the Jenkins shared library is hosted in this repository (under [`integrations/jenkins`](https://github.com/Purplemet/cli/tree/main/integrations/jenkins), as required by the Jenkins Global Pipeline Library). The other integrations are published to their own marketplaces and registries — follow each guide above.
